...
\\ \Rightarrow \varepsilon = \oint （v\times B)\cdot dl
\end{array}$$
...
$$
\varepsilon_i = \frac{1}{2}\omega L^2
$$
...
\oint _L E\cdot dl = - \frac{d\Phi_m}{dt} = -\oint \frac{\partial B}{\partial t} \cdot dS \\ \\
\oint _S B\cdot dS =0 \\ \\
\oint _L H\cdot dl =\sum {I} + \frac{d\Phi}{dt} =\int_S j\cdot dS +\int_S \frac{\partial D}{\partial t} \cdot dS 
\end{array}
$$
